...
> 一键适配国标GB/T 7714-2015与人文社科核心期刊官方体例
...
> 「典」者，奉学界通例为圭臬，立文章之规矩；「校」者，借现代科技补罅漏，正体例之讹误。以现代技术，效古人校书之功，让每一处引用皆合规，每一篇文献尽合范。
...
## 📄 开源协议
- 项目代码（UI界面与业务逻辑）：采用 **MIT License** 开源协议
- 核心Prompt模板（`prompts.py`）：采用 **CC BY-NC-SA 4.0 国际许可协议**，**严禁任何形式的商业化闭源使用与牟利**，二次修改分发需保留原署名并沿用相同协议

---

<p align="center">
  <span style="color: #888; font-size: 12px;">© 2026 CanonMaster · 典校大师 v1.0 | 仅限个人学习与学术研究使用</span>
</p>